...
Total height has larger effect sizes than rosette area in 2 out of 3 years (checked with models with scaled predictors). Use total height as condition variable.
...
```{r echo=TRUE}
fitness_2017_1<-lm(n_seeds~temp+I(temp^2)+log(tot_h),ping_17_data)
fitness_2018_1<-lm(n_seeds~temp+I(temp^2)+log(tot_h),ping_18_data)
fitness_2020_1<-lm(n_seeds~temp+I(temp^2)+log(tot_h),
...
```{r echo=TRUE}
fitness_2017_1<-glm(n_seeds~temp+I(temp^2)+log(tot_h),ping_17_data,
                    family="poisson")
fitness_2018_1<-glm(n_seeds~temp+I(temp^2)+log(tot_h),ping_18_data,
                    family="poisson")
fitness_2020_1<-glm(n_seeds~temp+I(temp^2)+log(tot_h),
...
fitness_2017_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),ping_17_data,
                    family="nbinom2")
fitness_2018_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),ping_18_data,
                    family="nbinom2")
fitness_2020_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2017_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),ziformula=~1,
                        ping_17_data,family="nbinom2")
fitness_2018_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),ziformula=~1,
                        ping_18_data,family="nbinom2")
fitness_2020_1<-glmmTMB(n_seeds~temp+I(temp^2)+log(tot_h),ziformula=~1,
                        subset(ping_20_data,treatment=="C"),family="nbinom2")
```
...
Quadratic effects of temperature never significant.

## Remove quadratic effects of temperature

```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2017_1<-glmmTMB(n_seeds~temp+log(tot_h),ziformula=~1,
                        ping_17_data,family="nbinom2")
fitness_2018_1<-glmmTMB(n_seeds~temp+log(tot_h),ziformula=~1,
                        ping_18_data,family="nbinom2")
...
Effect of temperature only significant in 2018.
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2017_2<-glmmTMB(n_seeds~temp+log(tot_h),ziformula=~.,
                        ping_17_data,family="nbinom2")
fitness_2018_2<-glmmTMB(n_seeds~temp+log(tot_h),ziformula=~.,
                        ping_18_data,family="nbinom2")
fitness_2020_2<-glmmTMB(n_seeds~temp+log(tot_h),ziformula=~.,
                        subset(ping_20_data,treatment=="C"),family="nbinom2")
```
...
```{r}
fitness_01_2017_1<-glm(fitness_01~temp+I(temp^2)+log(tot_h),ping_17_data,
                       family="binomial")
fitness_01_2018_1<-glm(fitness_01~temp+I(temp^2)+log(tot_h),ping_18_data,
                       family="binomial")
fitness_01_2020_1<-glm(fitness_01~temp+I(temp^2)+log(tot_h),
...
```{r}
fitness_01_2017_1<-glm(fitness_01~temp+log(tot_h),ping_17_data,
                       family="binomial")
fitness_01_2018_1<-glm(fitness_01~temp+log(tot_h),ping_18_data,
                       family="binomial")
fitness_01_2020_1<-glm(fitness_01~temp+log(tot_h),
                   subset(ping_20_data,treatment=="C"),family="binomial")
```
...
Including total height (log) as condition variable.

```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2020_treat<-glmmTMB(n_seeds~treatment+log(tot_h),ziformula=~1,
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2020_treat_2<-glmmTMB(n_seeds~treatment+log(tot_h),ziformula=~.,
                            ping_20_data,family="nbinom2")
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_01_2020_treat<-glm(fitness_01~treatment+log(tot_h),ping_20_data,
                           family="binomial")
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2020_temp_treat<-glmmTMB(n_seeds~temp*treatment+log(tot_h),ziformula=~1,
                            ping_20_data,family="nbinom2")
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_2020_temp_treat_2<-glmmTMB(n_seeds~temp*treatment+log(tot_h),
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
fitness_01_2020_temp_treat<-glm(fitness_01~temp*treatment+log(tot_h),
...
```{r}
summary(glm(fitness_01~temp+log(tot_h),subset(ping_20_data,treatment=="C"),
            family="binomial"))
summary(glm(fitness_01~temp+log(tot_h),subset(ping_20_data,treatment=="P"),
            family="binomial"))
summary(glm(fitness_01~temp+log(tot_h),subset(ping_20_data,treatment=="F"),
            family="binomial"))
summary(glm(fitness_01~temp+log(tot_h),subset(ping_20_data,treatment=="PF"),
            family="binomial")) # +*
```
...
ping_17_data$tot_h_std<-as.numeric(scale(log(ping_17_data$tot_h)))
ping_18_data$tot_h_std<-as.numeric(scale(log(ping_18_data$tot_h)))
ping_20_data$tot_h_std<-as.numeric(scale(log(ping_20_data$tot_h)))
# Relativize fitness
...
ping_20_data_C<-subset(ping_20_data,treatment=="C")%>%
  mutate(FFD_corr_std=as.numeric(scale(FFD_corr)),
         tot_h_std=as.numeric(scale(log(tot_h))),
...
```{r}
selection_2017_1<-lm(n_seeds_rel~FFD_corr_std*temp+tot_h_std,
                     subset(ping_17_data,
                            !is.na(n_seeds_rel)&!is.na(tot_h_std)))
selection_2018_1<-lm(n_seeds_rel~FFD_corr_std*temp+tot_h_std,
                     subset(ping_18_data,
                            !is.na(n_seeds_rel)&!is.na(tot_h_std)))
selection_2020_1<-lm(n_seeds_rel~FFD_corr_std*temp+tot_h_std,
                     subset(ping_20_data,
                            !is.na(n_seeds_rel)&!is.na(tot_h_std))) 
selection_2020_C_1<-lm(n_seeds_rel~FFD_corr_std*temp+tot_h_std,
...
summary(selection_2020_1) # * int temp:FFD
summary(selection_2020_C_1) # int temp:FFD, p=0.0562
```
...
plot(ggpredict(selection_2020_C_1,
               terms=c("FFD_corr_std","temp"))) # int temp:FFD, p=0.0562
```

2018: higher fitness in colder soils.
2020: early flowering relatively more favoured in colder soils (similar to result for Cerastium but it seems that there is no selection on FFD in warmer soils here - if we look only at plants in the C treatment - p=0.0562).
...
b <- car::Boot(selection_2017_1,slp, R=10000) # note the capital B
b1 <- boot::boot.ci(b,type="bca")
tot_h_std_ci <- as.data.frame(b1$bca[1,4:5])
rm(slp, b, b1)
...
BCIs_selection_2017_1 <- cbind(
  rbind(FFD_corr_std_ci[1,] ,temp_ci[1,], tot_h_std_ci[1,],
        FFD_corr_std_temp_ci[1,]),
  rbind(FFD_corr_std_ci[2,] ,temp_ci[2,], tot_h_std_ci[2,],
        FFD_corr_std_temp_ci[2,])
)
colnames(BCIs_selection_2017_1)<-c("lower","upper")
rownames(BCIs_selection_2017_1) <- c("FFD_corr_std","temp","tot_h_std",
                                     "FFD_corr_std_temp")
...
Similar to significances in the model, only CIs for tot_h_std not enclosing zero.
...
rownames(BCIs_selection_2018_1) <- c("FFD_corr_std","temp","tot_h_std",
                                     "FFD_corr_std_temp")
...
Similar to significances in the model, CIs for temp and tot_h_std not enclosing zero.
...
rownames(BCIs_selection_2020_1) <- c("FFD_corr_std","temp","tot_h_std",
                                     "FFD_corr_std_temp")
...
Similar to significances in the model, CIs for FFD_corr_std, tot_h_std and FFD_corr_std:temp not enclosing zero.
...
rownames(BCIs_selection_2020_C_1) <- c("FFD_corr_std","temp","tot_h_std",
                                     "FFD_corr_std_temp")
...
```{r}
selection_2020_2<-lm(n_seeds_rel~FFD_corr_std*treatment+tot_h_std,
                     subset(ping_20_data,!is.na(n_seeds_rel)&!is.na(tot_h_std)))
```
...
No significant effects (only tot_h_std).
...
```{r}
selection_2020_3<-lm(n_seeds_rel~temp*FFD_corr_std+temp*treatment+tot_h_std,
                     subset(ping_20_data,!is.na(n_seeds_rel)&!is.na(tot_h_std)))
```
...
BCIs_selection_2020_3 <- cbind(rbind(temp_ci[1,],FFD_corr_std_ci[1,] ,
                                     treatmentF_ci[1,],
                                     treatmentP_ci[1,], treatmentPF_ci[1,],
                                     tot_h_std_ci[1,],temp_FFD_corr_std_ci[1,],
                               ...
                               rbind(temp_ci[2,],FFD_corr_std_ci[2,] ,
                                     treatmentF_ci[2,],
                                     treatmentP_ci[2,], treatmentPF_ci[2,],
                                     tot_h_std_ci[2,],temp_FFD_corr_std_ci[2,],
...
```{r}
selection_2020_6<-lm(n_seeds_rel~temp*FFD_corr_std*treatment+tot_h_std,
                     subset(ping_20_data,!is.na(n_seeds_rel)&!is.na(tot_h_std)))
```
